...
- 商品をみかん5とりんご10を購入した場合、何も考えずに1テーブルと1レコードで表示する以下になります。
    ...
    |3| みかん|100|5|りんご|200|10|2750|
    |4| みかん|100|5|りんご|200|10|2750|
    |5| みかん|100|5|りんご|200|10|2750|

  　</br>このように全く同じ商品情報を複数レコードに持たしてしまいます。
  　</br>管理上問題なく見えますがみかんの商品名が変わったときに、みかんと表記されたデータを複数件直す必要があります。
  　</br>みかんという商品名自体は一つしかない為、注文の内容を複数件直すのは無駄な工数となってしまいます。
...
- 注文を扱うデータのイメージ<br>
  注文のデータを扱うイメージ以下になります。 
    ...
    </br>商品ID以外の商品に関する情報は外出しできましたが
    </br>これだと似たようなカラムが存在します。
  　</br>誰がいつ購入したかの情報と購入した商品の情報を別で管理することで、管理しやすくなります。
　　</br>その為、注文のテーブルと注文明細テーブルを作ります。
...
※2レコード目　西村が2023/7/13にPC、イヤホン、マウス、マイク1個ずつ <br>
